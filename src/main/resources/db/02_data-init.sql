...
insert into otus_highload.post(from_user, to_user, text)
VALUES ('370c779a-3570-49e4-b066-34f1c06f494d', null, 'text 1'),
       ('370c779a-3570-49e4-b066-34f1c06f494d', null, 'text 2'),
       ('370c779a-3570-49e4-b066-34f1c06f494d', null, 'text 3'),

       ('19bc1d82-b91f-4759-a62a-c8d199e29358', null, 'text 4'),
       ('19bc1d82-b91f-4759-a62a-c8d199e29358', null, 'text 5'),
       ('19bc1d82-b91f-4759-a62a-c8d199e29358', null, 'text 6'),

       ('abbdd14d-9dfb-434d-8696-fbffa0d52d5d', null, 'text 7'),
       ('abbdd14d-9dfb-434d-8696-fbffa0d52d5d', null, 'text 8'),
       ('abbdd14d-9dfb-434d-8696-fbffa0d52d5d', null, 'text 9'),

       ('6bf4f55a-a1af-4fe2-a895-a14abca5a5e7', null, 'text 10'),
       ('6bf4f55a-a1af-4fe2-a895-a14abca5a5e7', null, 'text 11'),
       ('6bf4f55a-a1af-4fe2-a895-a14abca5a5e7', null, 'text 12'),

       ('458fda80-8253-4da3-b4a8-83826b667931', null, 'text 13'),
       ('458fda80-8253-4da3-b4a8-83826b667931', null, 'text 14'),
       ('458fda80-8253-4da3-b4a8-83826b667931', null, 'text 15'),

       ('054bfb6b-3540-433b-a2c4-480612487285', null, 'text 16'),
       ('054bfb6b-3540-433b-a2c4-480612487285', null, 'text 17'),
       ('054bfb6b-3540-433b-a2c4-480612487285', null, 'text 18'),

       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 119'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 120'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 121'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 122'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 123'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 124'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 125'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 126'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 127'),
       ('10775498-ae09-4e13-a2ff-f7c1e190043f', null, 'text 128');